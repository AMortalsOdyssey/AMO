      ...
      <section className="amo-panel rounded-[2rem] p-6 md:p-8">
        ...
        <div className="space-y-6 text-sm leading-7 text-white/70">
          ...
          <section>
            ...
            <p className="mt-3">
              支付流程由第三方支付服务商 Creem 安全处理，AMO 不直接保存你的银行卡或完整支付凭证。支付成功后如额度未及时到账，请通过支持邮箱{" "}
              <a href={SUPPORT_EMAIL_HREF} className="text-emerald-200 hover:text-emerald-100">
                {SUPPORT_EMAIL}
              </a>{" "}
              联系我们，并提供订单相关信息以便核查。退款、拒付或支付争议将结合 Creem 的交易记录、支付服务商规则以及 AMO 的实际服务交付情况处理。
            </p>
          </section>

          <section>
            <h2 className="mb-2 text-lg font-medium text-white/88">6. 联系方式</h2>
            <p>
              如需账户支持、支付支持、额度到账核查或服务咨询，请发送邮件至{" "}
              <a href={SUPPORT_EMAIL_HREF} className="text-emerald-200 hover:text-emerald-100">
                {SUPPORT_EMAIL}
              </a>
              。
          ...
          <section>
            <h2 className="mb-2 text-lg font-medium text-white/88">7. 协议更新</h2>
            <p>
